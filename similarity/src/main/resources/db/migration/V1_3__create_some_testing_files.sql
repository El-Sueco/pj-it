INSERT INTO file (name, file_name, content, type_id, department_id)
VALUES ('SumFile', 'file.xml', '<?xml version="1.0" encoding="UTF-8"?>
        <CATALOG>
            <CD>
       ...
       ('SumOtherFile', 'file2.xml', '<?xml version="1.0" encoding="UTF-8"?>
        <CATALOG>
            <CD>
            <TITLE>dill diya galla</TITLE>
            <ARTIST>Arijit singh</ARTIST>
